...
public class RepositoryStructure<T> implements RepositoryBase.RepositoryLoad<T>, RepositoryBase.RepositorySave<T> {
	private final IoFunc.FunctionIo<Path, Path> getProjFile;
	private IoFunc.FunctionIo<Path, T> loadProjFile;
	private IoFunc.BiConsumerIo<Path, T> saveProjFile;
	 ...
	 */
	public RepositoryStructure(String fileName, IoFunc.FunctionIo<Path, T> projFileLoader, IoFunc.BiConsumerIo<Path, T> projFileSaver) {
	 ...
	 * @param projFileLoader a function which takes a path and returns data related to that path, most likely by loading the file and returning some part of its contents
	 */
	public RepositoryStructure(FunctionIo<Path, Path> projFileGetter, IoFunc.FunctionIo<Path, T> projFileLoader, IoFunc.BiConsumerIo<Path, T> projFileSaver) {
